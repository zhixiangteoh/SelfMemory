    ...
    if not has_memory:
        ...
        if memory_encoding == "concate":
            ...
            tokenized_src = tokenizer(
                ...
                max_length=min(tokenizer.model_max_length, max_src_len + max_trg_len),
                return_attention_mask=True,
            )
            return {
                "input_ids": tokenized_src["input_ids"],
...
class ConditionalGenerator(LightningModule):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.hparams.eval_metrics == "ppl":
            ...
            self.hparams.do_generation = True
        self.losses = []
        ...
        with torch.no_grad():
            ...
            if self.hparams.num_return_sequences is None:
                ...
                num_return_sequences = (
                    ...
                    * int(self.hparams.num_beams / self.hparams.num_beam_groups)
                    if self.hparams.num_beam_groups is not None
                    else self.hparams.num_return_sequences
                )
